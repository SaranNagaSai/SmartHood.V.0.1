...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-gradient-brand p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-[400px] bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 relative z-10 animate-slide-up">
                <div className="text-center mb-8">
                    <div className="flex flex-col items-center justify-center gap-2 mb-6">
                        <img src={smartHoodLogo} alt="SmartHood" className="w-24 h-24 object-contain" />
                        <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">SmartHood</h2>
                    </div>
